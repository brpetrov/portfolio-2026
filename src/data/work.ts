...
export const builds: readonly Build[] = [
  ...
  },
  {
    ...
    images: [
      { src: "images/dun-bun-finance/app-1.jpg", alt: "Dun Bun Finance — dashboard and spending history" },
      { src: "images/dun-bun-finance/app-4.jpg", alt: "Dun Bun Finance — dashboard with expense groups and savings pots" },
      { src: "images/dun-bun-finance/app-3.jpg", alt: "Dun Bun Finance — monthly spending history chart" },
      { src: "images/dun-bun-finance/app-2.jpg", alt: "Dun Bun Finance — onboarding walkthrough" },
    ],
  ...
  },
  {
    ...
    images: [
      { src: "images/lean-streak/app-1.jpg", alt: "LeanStreak — Today dashboard and progress calendar, light and dark themes" },
      { src: "images/lean-streak/app-2.jpg", alt: "LeanStreak — meal logging by voice with AI estimation" },
      { src: "images/lean-streak/app-4.jpg", alt: "LeanStreak — green/yellow/red progress calendar" },
      { src: "images/lean-streak/app-3.jpg", alt: "LeanStreak — navigation menu" },
      { src: "images/lean-streak/sign-in.jpg", alt: "LeanStreak — sign-in screen of the live web app" },
    ],
